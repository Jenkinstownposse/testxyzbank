...
var BankManagerTest_1 = require("../../xyz_bank/pages/BankManagerTest/BankManagerTest");
var jsd = require('../../xyz_bank/data/testData');
var customerdetails = new BankManagerTest_1.AddCustomer();
...
describe('bankmanager', function () {
    ...
    it('launch and enter value in Bankmanager', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, protractor_1.browser.get(jsd.CustomerData1.url)];
                case 1:
                    _a.sent();
